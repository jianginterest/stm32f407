...
#define IRQ_H     GPIO_SetBits(GPIOD,GPIO_Pin_11)

#define READ_IRQ    GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_12)
...
uint8_t NRF24L01_TxPacket(u8 *txbuf);            
uint8_t NRF24L01_RxPacket(u8 *rxbuf);    

extern uint8_t  NRF_Buff[TX_PLOAD_WIDTH];
